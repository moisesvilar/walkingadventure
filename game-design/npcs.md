...
1. ~~**Si dos caras del mismo sitio cuentan como el mismo lugar para el casting.** Hoy hay una regla de que dos roles no pueden caer en el mismo lugar, y varias caras de una posada comparten coordenadas exactas. Propuesta pendiente de ratificar: **sí cuentan como el mismo lugar**, porque una aventura que te manda dos veces al mismo portal no es una aventura.~~ → **hecho** el 13-ago-2026: **ratificado, sí cuentan como el mismo lugar**, y la regla se escribe entera porque hacía falta más de lo que el pendiente pedía. **Un beat sobre un rol humano ocurre en el sitio donde esa persona trabaja: la cara añade quién habla, no dónde.** Todo lo que mide, sitúa, marca o pide recursos lo trata como ese sitio; solo la escena y las caras del desenlace miran a la persona. Lo que lo destapó fue medirlo: hasta hoy ninguna plantilla ponía un beat sobre su rol humano —0 de 506 en los cuatro mundos de referencia—, así que la regla no se había tenido que aplicar nunca, y al aplicarla no fallaba con un motivo sino con un `TypeError`, porque los roles humanos se resuelven **después** del reparto y su lugar no existe cuando las comprobaciones corren: el chequeo de trecho y el del lazo se saltaban en silencio. Corolario, y es lo que se lleva a la doctrina: **no se ablanda ninguna regla, se hace que el lugar exista cuando las reglas se comprueban.** Con la regla puesta, la casteabilidad no se mueve —103 de 120 antes y después en los cuatro mundos, con las 120 cadenas de sitios idénticas beat a beat— y aparecen 69 beats con cara donde había 0. Está implementado en SPEC-051; el pendiente 3 lo había cerrado antes SPEC-014, con la plantilla de puestos como tope.
